...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::get('/profile/{id}/follower', [ProfileController::class,  'followers'])->name('profile.followers');
    Route::get('/profile/{id}/following', [ProfileController::class,  'following'])->name('profile.following');

    #LIKE
    Route::get('/like/{post_id}/store', [LikeController::class, 'store'])->name('like.store');
